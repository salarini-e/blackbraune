<div class="main-content">
    <div class="dashboard-main">
        <div class="page-header">
            <div class="header-left">
                <h1>Novo Contato</h1>
                <p>Adicione um novo contato para o rodapé do site</p>
            </div>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <form method="POST" action="<?= Router::url('contactos/create') ?>" class="contact-form">
                <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea class="form-input" id="valor" name="valor" rows="3" required
                              placeholder="Ex: contato@blackbraune.com.br, (22) 99999-9999, @blackbraune..."><?= htmlspecialchars($_POST['valor'] ?? '') ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-button">
                            <input type="text" class="form-input" id="icone" name="icone"
                                   ...
                                   value="<?= htmlspecialchars($_POST['icone'] ?? '') ?>">
                        ...
                        <div id="icon-preview" class="icon-preview-area"></div>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-switch">
                            <input type="checkbox" id="ativo" name="ativo" checked class="switch-input">
