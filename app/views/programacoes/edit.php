    ...
    <div class="dashboard-main">
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Modifique os dados da atividade: <strong><?= htmlspecialchars($programacao['titulo']) ?></strong></p>
            </div>

            <form method="POST" action="<?= Router::url('programacoes/update/' . $programacao['id']) ?>" id="programacaoForm">
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                value="<?= $_SESSION['form_data']['data_evento'] ?? $programacao['data_evento'] ?>"
                                required
                            >
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                <?php foreach ($tipos as $key => $tipo): ?>
                                    <option value="<?= $key ?>" <?= (($_SESSION['form_data']['tipo_atividade'] ?? $programacao['tipo_atividade']) === $key) ? 'selected' : '' ?>>
                                        <?= $tipo ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                value="<?= $_SESSION['form_data']['horario_inicio'] ?? $programacao['horario_inicio'] ?>"
                                required
                            >
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                value="<?= $_SESSION['form_data']['horario_fim'] ?? $programacao['horario_fim'] ?>"
                            >
                    ...
                    <div class="form-group full-width">
                        ...
                        <input 
                            ...
                            value="<?= $_SESSION['form_data']['titulo'] ?? htmlspecialchars($programacao['titulo']) ?>"
                    ...
                    <div class="form-group full-width">
                        ...
                        <input 
                            ...
                            name="local" 
                            class="form-input"
                            value="<?= $_SESSION['form_data']['local'] ?? htmlspecialchars($programacao['local'] ?? '') ?>"
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea 
                            ...
                            rows="4"
                        ><?= $_SESSION['form_data']['descricao'] ?? htmlspecialchars($programacao['descricao'] ?? '') ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <label class="checkbox-label">
                            <input 
                                ...
                                id="ativo" 
                                name="ativo" 
                                <?= (($_SESSION['form_data']['ativo'] ?? $programacao['ativo']) == '1') ? 'checked' : '' ?>
                            >
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="form-info">
                                <?= date('d/m/Y H:i', strtotime($programacao['created_at'])) ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-info">
                                <?= date('d/m/Y H:i', strtotime($programacao['updated_at'])) ?>
                            </div>
                        </div>
                    </div>
                </div>
